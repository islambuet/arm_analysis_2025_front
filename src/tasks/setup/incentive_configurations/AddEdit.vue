...
const setInputFields=async ()=>{
  ...
  inputFields[key] = {
    ...
    label: labels.get('label_'+key),
    type:'dropdown',
    options:[{value:'NET_SALE_ADJUSTMENT',label:'Net Sales Adjustment'},{value:'INCENTIVE_HOM',label:'HOM Incentive'},{value:'INCENTIVE_PART',label:'Part Incentive'},{value:'INCENTIVE_AREA',label:'Area Incentive'},{value:'INCENTIVE_TERRITORY',label:'Territory Incentive'}],
    default:item.data[key],
    mandatory:true
  };
  key='config_value';
